...
prompt_dict = {
    'default': 'ответь на сообщение: {message}.\nответ должен быть на том же языке, что и сообщение юзера, это важно.\nне используй разметку latex или markdown.',
    'blond': 'ответь на сообщение: {message}.\nне используй разметку latex или markdown, пиши КАК МОЖНО КОРОЧЕ.',
    'hitler': 'ответь на сообщение: {message}.\nне используй разметку latex или markdown, пиши КАК МОЖНО КОРОЧЕ, просто.',
